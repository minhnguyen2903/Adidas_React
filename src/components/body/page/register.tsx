...
const AccountRegister = () => {
    ...
    const submitAction = async() => {
        ...
        await axios.post(`${process.env.REACT_APP_SERVER_URL}/register`, data, { headers: { 'Content-Type': 'multipart/form-data' } }).then((res: any) => {
                        ...
                        <div className="col-md-6 border-start border-end p-5 col-12">
                            ...
                            <div>
                                ...
                                <div className="mt-3">
                                    ...
                                    <InputComponent label="First Name" name="firstName" handleChange={handleChange} />
                                    <InputComponent label="Last Name" name="lastName" handleChange={handleChange} />
                                </div>
                                <div className="mt-3">
                                    <h3
                                    ...
                                    <DateInput name="birth" handleChange={handleChange} />
                                    <p>
                                        We collect date of birth to comply with
                                        our{" "}
                                        <a
                                            href="/privacy"
                                        ...
                                        . Plus you will get a surprise from us
                                        on your birthday!
                                    </p>
                                </div>
                                <div className="mt-3">
                                    ...
                                    <InputComponent label="email" name="email" handleChange={handleChange}/>
                                    <InputComponent label="password" name="password" handleChange={handleChange} />
                                </div>
                                <div className="mt-3">
                                    ...
                                    <div className="row">
                                        ...
                                        >
                                            I hereby consent to the use of my
                                            personal data for marketing and
                                            promotional purposes as set out in
                                            the adidas{" "}
                                            <a
                                                href="/privacy"
                                                className="text-underline text-hover-bg-dark"
                                    ...
                                    <div className="row">
                                        ...
                                        >
                                            I hereby consent to the transfer,
                                            sharing, use, collection and
                                            disclosure of my personal data to
                                            third parties as set out in the
                                            adidas{" "}
                                            <a
                                                href="/privacy"
                                                className="text-underline text-hover-bg-dark"
