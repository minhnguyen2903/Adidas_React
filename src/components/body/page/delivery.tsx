...
const Delivery = () => {
  ...
  const submitDelivery = () => {
    ...
    Object.keys(deliveryInfo).forEach((element: any) => {
      if ((deliveryInfo as any)[element] === "") {
        setIsValid(false);
        setDisabled(false);
      }
    });
    ...
    <div className="row justify-content-center">
      ...
      <div className="content-container col-lg-10 row p-2 p-lg-5">
        <div className="col-md-7">
          <h3 className="text-uppercase text-700">shipping address</h3>
          <div className="row justify-content-between">
            ...
            <div style={{ width: "49%", height: "fit-content" }}>
              <InputComponent
                ...
                name="lastName"
                isValid={isValid}
                val={deliveryInfo.lastName}
                handleChange={handleChange}
              />
            </div>
          </div>
          <div className="row justify-content-between">
            <div className="col-sm-4 pe-sm-2" style={{ height: "fit-content" }}>
              <SelectLocation
                values={province}
            ...
            <div className="col-sm-4 ps-sm-2" style={{ height: "fit-content" }}>
              <SelectLocation
                values={ward}
          ...
          <div className="mt-3">
            <div className="mt-5">
              <h3 className="text-uppercase text-700">ARRIVING</h3>
              <div className="row p-3 border mb-3 mt-3">
                ...
                <div className="d-flex justify-content-between">
                  ...
                  <div style={{ width: "calc(100% - 45px)" }}>
                    DHL (Due to the impact of Covid-19, please expect that
                    delivery could be delayed or unavailable in some regions
                    yet. We apologise for any inconvenience caused!)
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="row w-100 m-0 mt-2">
              ...
              >
                I hereby consent to the use of my personal data for marketing
                and promotional purposes as set out in the adidas Privacy
                Notice.
              </p>
            </div>
            <div className="row w-100 m-0 mt-2">
              ...
              >
                I have read, understood and accepted the Privacy Notice and
        ...
        <div className="col-md-5 d-none d-md-block ps-3 pe-3">
          <div className="border p-3">
            <h3 className="text-uppercase text-700 mb-3">order sumary</h3>
            <div className="d-flex justify-content-between">
              <p className="text-uppercase">{products.length} items</p>
          ...
          <div>
            <h4 className="text-regular text-700">ACCEPTED PAYMENT METHODS</h4>
            <img src={Payment} alt="img" />
          </div>
          <div className="border p-3">
            <h3 className="text-700 mb-3 text-medium">ORDER DETAILS</h3>
            <div style={{ zoom: "75%" }}>
