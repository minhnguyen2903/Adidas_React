...
import {ToggleDropdown, SortDropdown} from "../../GlobalComponent/button-dopdown";
        ...
        <div className="content-container col-lg-10 pe-3 ps-3">
          <div className="content-top pb-3">
            ...
            <div className="filter">
              <div className="row justify-content-between filter-bar border-top border-bottom pt-1 pb-1">
                <div className="row w-auto">
                  <ToggleDropdown
                    ...
                    hide={
                      compareSearchKey(searchKey, ["men", "women", "kid"])
                        ? true
                        : false
                    }
                  />
                  <ToggleDropdown
                    id="division"
                    category="DIVISION"
                    dropdown={["clothes", "shoes", "accessories"]}
                    hide={
                  ...
                  <ToggleDropdown
                    id="size"
                    category="SIZE"
                    dropdown={["1", "10.5 UK", "104", "10K"]}
                  />
                  <ToggleDropdown
                    id="colour"
                    category="COLOUR"
                    dropdown={["black", "white", "red", "yellow", "multicolor"]}
                  />
                </div>
                <div className="row w-auto">
                <SortDropdown
                    id="sort"
                    category="SORT BY"
                    dropdown={["price up", "price down", "A - Z", "Z - A"]}
                  />
                </div>
              </div>
            </div>
