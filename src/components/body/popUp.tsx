...
const PopUp = (props: any) => {
    ...
    return (
        <div
            className="row index-999 bg-dark-gradient align-content-center justify-content-center"
            style={{
                width: "100vw",
                height: "100vh",
                position: "fixed",
        ...
        >
            <div className="bg-white index-999 col-7 p-3 position-relative border border-dark">
            <div
                ...
                style={{ height: "40px", width: "40px", right: "-20px", top: "-20px"}}
                onClick={handlePopUp}
            >
                <Icon>close</Icon>
            </div>
                ...
                <div className="row w-100">
                    <div className="row w-100">
                            ...
                            <div className="col-6">
                                ...
                                <div className="mt-3">
                                    <span className="text-700">
                                        {Helper.CountNumber([props.detail.price])}
                                    </span>
                                    đ
                                </div>
                        ...
                        <div className="col-6 p-3 border-start border-dark">
                            <div>
                                <div className="text-uppercase text-700">
                                    your bag
                                </div>
                                <div>{products.length} {products.length > 1 ? "item": "items"}</div>
                                <div className="d-flex justify-content-between">
                                    <span className="text-capitalize">
                                        total product cost
                                    </span>
                                    <span>{Helper.CountNumber([totalPrice()])}đ</span>
                                </div>
