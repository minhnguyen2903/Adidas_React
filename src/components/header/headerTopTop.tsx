    ...
    return(
        <div className="row justify-content-end pt-2 d-none d-lg-flex">
            <ul className="row m-0 w-auto">
                ...
                <li className="ms-3 cursor-pointer w-auto">{signIn.signIn?.isSigned?<Link to="/myAccount" className="text-small cursor-pointer">{signIn.signIn.res?.email}</Link>:<Link to="/account-login" className="text-small cursor-pointer">login</Link>}</li>
